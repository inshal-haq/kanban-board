...
const TaskItem: React.FC<{ task: Task; columnIndex: number }> = (props) => {
  ...
  return (
    <>
      ...
      />
      <div
        className="item hover:text-main-green dark:hover:text-main-green flex w-[280px] cursor-pointer flex-col justify-center gap-2 rounded-lg bg-white px-4 py-6 shadow-md dark:bg-dark-gray dark:text-white"
